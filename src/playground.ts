...
<div class="section" id="system">
  <div class="section-head rv">
    <div class="bg-word">System</div>
    <div class="kicker">MCP and beyond · one source of truth</div>
    <h2 class="sh">Four surfaces. <span class="glow">One system.</span></h2>
    <p class="sp">This playground is the front door to a complete, free, open-source operating system a real company runs on. The <b style="color:#e8ebe8">MCP is the brain</b>; three more surfaces put the same books in everyone's hands — all MIT, all deployable for <b style="color:#e8ebe8">your</b> company in an afternoon-to-a-weekend.</p>
  </div>
  <main><div class="grid">
    <div class="card rv">
    ...
    <div class="card rv">
      <div class="eyebrow">✋ the crew's hands</div>
      <h2>The field app</h2>
      <p class="hint">One tap in the truck — photo, receipt, FLHA sign-off, hazard, note — lands in the App Inbox for the brain to file. $0/month on Google Apps Script, in daily production use. Safety escalates immediately; everything else queues.</p>
      <div><a class="btn-pill outline" href="https://github.com/kr8tiv-ai/evolve-field-app">Source (MIT) →</a></div>
    </div>
    <div class="card rv">
      <div class="eyebrow">📊 the spine</div>
      <h2>The workbook + Router</h2>
      <p class="hint">The whole operation as a 25-tab Google Sheet — quotes, dispatch, expenses, safety, price watch, maintenance, Job P&amp;L — generated by the MCP in one command, read and written through a secret-gated Apps Script Router. Deployable template; you mint your own secret.</p>
      <div><a class="btn-pill outline" href="https://github.com/kr8tiv-ai/evolve-ops-workbook">Template (MIT) →</a></div>
    </div>
    <div class="card rv">
      <div class="eyebrow">📈 the owner's eyes · live</div>
      <h2>The admin dashboard</h2>
      <p class="hint">Login-protected finance charts, clickable job P&amp;Ls, quotes, invoices and receivables, filterable receipts, audit-ready safety, maintenance, and inventory with a materials price tracker. Reads the same workbook — its <span class="mono">evolved</span> profile drives an MCP-generated sheet out of the box.</p>
      <div><a class="btn-pill" href="https://ops.evolveecoblasting.com">See it live →</a> <a class="btn-pill outline" href="https://github.com/kr8tiv-ai/evolve-dashboard">Source (MIT) →</a></div>
    </div>
  </div></main>
</div>
...
<footer>
  ...
  <div style="margin-top:12px; letter-spacing:.1em">FOUR SURFACES, ONE SYSTEM &middot;
    <a href="https://github.com/kr8tiv-ai/evolved">MCP BRAIN</a> &middot;
    <a href="https://github.com/kr8tiv-ai/evolve-field-app">FIELD APP</a> &middot;
    <a href="https://github.com/kr8tiv-ai/evolve-ops-workbook">WORKBOOK + ROUTER</a> &middot;
    <a href="https://ops.evolveecoblasting.com">OWNER DASHBOARD (LIVE)</a></div>
  <div class="madeby">
